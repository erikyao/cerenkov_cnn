...
"""
Seventh trial of LeNet5 inspired models
Same model configs with cnn_exp2_LeNet5 except using selu for activations
"""
...
# Use wide conv, small-stride max pooling layers
# Use deeper structure
model_configs = [("InputLayer:9x2001x1",
                    "Conv2D:8-1x9-1x1-selu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:8-1x9-1x1-selu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-selu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-selu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-selu-valid",
                    ...
                    "Conv2D:16-1x9-1x1-selu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-3x3-1x1-selu-valid",
                    "MaxPooling2D:2x2-2x2-valid",
                    "Flatten", 
                    "Dense:120-selu", 
                    "Dense:84-selu",
                    "Dense:10-selu",
                    "Dense:1-sigmoid") for w in [2]]
