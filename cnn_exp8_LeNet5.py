...
"""
Eight trial of LeNet5 inspired models
Same model configs with cnn_exp7_LeNet5 except using relu for activations
"""
...
model_configs = [("InputLayer:9x2001x1",
                    "Conv2D:8-1x9-1x1-relu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:8-1x9-1x1-relu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-relu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-relu-valid",
                    "MaxPooling2D:1x{}-1x{}-valid".format(w, w),
                    "Conv2D:16-1x9-1x1-relu-valid",
