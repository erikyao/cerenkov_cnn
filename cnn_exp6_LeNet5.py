...
"""
Sixth trial of LeNet5 inspired models
Same model configs with cnn_exp3_LeNet5 except 

1. using a 3x3 conv at the 1st layer (instead of a long 1xW conv)
2. deleting the last max pooling to avoid negative dimensions
"""
...
# LeNet-5 inspired models: ICMpCMpCMpCFDDDD
# Use wide conv and wide max pooling layers
model_configs = [("InputLayer:9x2001x1",
                    "Conv2D:8-3x3-1x1-selu-valid",
                    "MaxPooling2D:1x4-1x4-valid",
                    "Conv2D:8-1x{}-1x1-selu-valid".format(w ** 2),
                    "MaxPooling2D:1x4-1x4-valid",
                    "Conv2D:16-1x{}-1x1-selu-valid".format(w ** 2),
                    "MaxPooling2D:1x4-1x4-valid",
                    "Conv2D:16-{}x{}-1x1-selu-valid".format(w, w),
                    "MaxPooling2D:2x2-2x2-valid",
                    "Flatten", 
                    "Dense:120-selu", 
                    "Dense:84-selu",
                    "Dense:10-selu",
                    "Dense:1-sigmoid") for w in [3, 5]]
