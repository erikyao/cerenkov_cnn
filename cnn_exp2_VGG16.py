...
"""
Second trial of VGG16 inspired models
Use relu instead of selu
"""
...
# VGG16 inspired models: ICCMpCCMpCCMpCCMpFDDDD
...
model_configs = [("InputLayer:9x2001x1",
                    ...
                    "Conv2D:16-1x{}-1x1-relu-valid".format(w ** 2),
                    "MaxPooling2D:1x4-1x4-valid",
                    "Conv2D:16-1x{}-1x1-relu-valid".format(w, w ** 2),
