...
"""
First trial of LeNet5 inspired models
"""
...
# LeNet-5 inspired models: ICApCApCApCApFDDDD
# Use wide conv and wide average pooling layers
model_configs = [("InputLayer:9x2001x1",
                    "Conv2D:8-1x{}-1x1-relu-valid".format(w ** 2),
                    "AveragePooling2D:1x4-1x4-valid",
                    "Conv2D:8-1x{}-1x1-relu-valid".format(w ** 2),
                    "AveragePooling2D:1x4-1x4-valid",
                    "Conv2D:16-1x{}-1x1-relu-valid".format(w ** 2),
                    "AveragePooling2D:1x4-1x4-valid",
                    "Conv2D:16-{}x{}-1x1-relu-valid".format(w, w),
                    "AveragePooling2D:2x2-2x2-valid",
                    "Flatten", 
                    "Dense:120-relu", 
                    "Dense:84-relu",
                    "Dense:10-relu",
